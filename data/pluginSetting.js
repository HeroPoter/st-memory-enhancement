...
export const defaultSettings = await switchLanguage('__defaultSettings__', {
  ...
  deleteRow(1, 2)
  insertRow(1, {0:"悠悠", 1:"女/26岁/高个微胖/面容清秀/黑色长发/青色干净的杂役服/灰色破烂的杂役长裤/灰色干净的布鞋/腰间佩戴玉佩", 2:"开朗活泼", 3:"学生", 4:"羽毛球", 5:"鬼灭之刃", 6:"宿舍", 7:"运动部部长"})
  insertRow(1, {0:"<user>", 1:"男/36岁/矮个瘦弱/面容冷峻/白色短发/红色干净的道袍/黑色色破烂的杂役长裤/灰色干净的球鞋/颈项佩戴金项链", 2:"忧郁", 3:"学生", 4:"唱歌", 5:"咒术回战", 6:"自己家", 7:"学生会长"})
  ...
  insertRow(5, {"0":"<user>","1":"社团赛奖品","2":"奖杯","3":"1瓶(10粒)","4":"比赛第一名"})
  -->
  </tableEdit>
  `,
    /**
